  ...
  return (
    <div className='xl:mx-96 mt-32 flex flex-col gap-12 video-container'>
      ...
      <motion.iframe
        ...
        allowFullScreen
        className='video self-center 2xl:self-start w-full md:w-[70%] h-[130px] sm:h-[200px] md:h-[250px] xl:h-[500px]'
      ...
      <motion.iframe
        ...
        allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share'
        allowFullScreen
        className='video self-center 2xl:self-end w-full md:w-[70%] h-[130px] sm:h-[200px] md:h-[250px] xl:h-[500px]'
